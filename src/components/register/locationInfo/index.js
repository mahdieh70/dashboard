...
const LocationInfo = ({ decreaseStepHandler }) => {
  ...
  const provinceRelatedCities = cities.filter((item) => {
    return (item.province).toString() === selectecProvince;
  });
  ...
  return (
    <>
      ...
      <div className="w-full h-full">
        <div className="flex items-center flex-col h-[76vh] text-center border border-solid border-[#D6D6D6] border-t-0 border-r-0 border-l-0">
          <div>
            ...
            <div className="relative w-[660px] gap-[16px] flex">
              ...
              <div className="flex items-center w-[322px] h-[60px] relative rounded-[50px] border border-solid border-[#D6D6D6]">
                ...
                <div className="relative w-full flex px-[10px]">
                  ...
                  <select className="w-full" {...formik.getFieldProps("city")}>
        ...
        <div className="flex flex-row-reverse items-center h-[11vh] justify-between">
